...
namespace LunarPayment\lib\HttpClient;

use LunarPayment\lib\Exception\ApiConnection;
use LunarPayment\lib\Exception\ApiException;
use LunarPayment\lib\Exception\Conflict;
use LunarPayment\lib\Exception\Forbidden;
use LunarPayment\lib\Exception\InvalidRequest;
use LunarPayment\lib\Exception\NotFound;
use LunarPayment\lib\Exception\Unauthorized;
use LunarPayment\lib\Response\ApiResponse;
    ...
    private function handleCurlError($url, $errno, $message)
    {
        switch ($errno) {
            ...
            case CURLE_SSL_PEER_CERTIFICATE:
                $msg
                    = "Could not verify api endpoint's SSL certificate."; // highly unlikely
                break;
            case CURLE_COULDNT_CONNECT:
            case CURLE_COULDNT_RESOLVE_HOST:
            case CURLE_OPERATION_TIMEOUTED:
                $msg
                    = "Could not connect to api endpoint ($url).  Please check your internet connection and try again.";
                break;
            default:
                $msg = "Unexpected error communicating with api endpoint.";
        }

        $msg .= "\n\n(Network error [errno $errno]: $message)";
        throw new ApiConnection($msg, 500);
    }
