...
namespace LunarPayment\lib\Data;
...
class Currencies
{
	 ...
	 * @return int|number
	 */
	private function getCurrencyDivider( $currency_iso_code ) {
		return $this->getCurrencyMultiplier( $currency_iso_code );
	}
	 ...
	 * @return int
	 */
	public function ceilRoundAmount( $amount, $currencyCode ) {
		...
		return ceil( round( $amount, 3 ) * $this->getCurrencyMultiplier( $currencyCode ) );
	}
